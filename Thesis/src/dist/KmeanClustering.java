...
public class KmeanClustering {
	...
	System.out.print("K"+(i+1)+"{ ");
	//System.out.print(descript.get(1)+"}");
	System.out.println();
	//for(int j=0;k[i][j]!=-1 && j<Nelements-1;++j)
	System.out.print("K"+(i+1+1)+"{ ");
	//System.out.print(descript.get(0)+", "+descript.get(2)+", "+descript.get(3)+"}");
	System.out.println("}");
	
	//C:\Users\buvan.suji\workspace\Distance\SampleData\results\chr11119005_1121390.fasta
	}
	}
}

 ...
 *
 */
public class TreadsDescriptionFromFasta {
    ...
    public TreadsDescriptionFromFasta(String filename){
    ...
    public static void FileReading(String filename){	
    	TreadsDescriptionFromFasta fsf= new TreadsDescriptionFromFasta(filename);
    	StringBuffer buffer1 = new StringBuffer();
    	
    	for (int i=0; i< fsf.size(); i++){    		
    		String temp = ((buffer1.append(fsf.getDescription(i))).deleteCharAt(0)).toString();
    		Rname.add(temp);
    ...
    public static void DestReads() throws Exception{
    	...
    	fname = (new BufferedReader(new InputStreamReader(System.in))).readLine();
